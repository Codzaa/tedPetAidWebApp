...
class MyDateModelAdapter extends TypeAdapter<MyDateModel> {
  @override
  final int typeId = 4;

  @override
  MyDateModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return MyDateModel(
      ...
      carerUsername: fields[2] as String,
      ownerUsername: fields[3] as String,
      petName: fields[4] as String,
      location: fields[5] as String,
      petDetails: fields[6] as String,
    );
  }

  @override
  void write(BinaryWriter writer, MyDateModel obj) {
    writer
      ..writeByte(7)
      ..writeByte(0)
      ..write(obj.id)
